...
if(isset($_GET['dId'])){
    $id = $_GET['dId'];
    $query = "DELETE FROM portfolio_category WHERE id = '$id'";
                    ...
                    <div class="row card-box">
                        <div class="col-md-12">
                            <div  id="Show_target_div">
                                <form name="form" action="action/portfolio_category.php"
                                      id="form"
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="form-label" for="cat_name">Product Category name:</label>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="portfolio_category.php?hId=<?php if (isset($row['id']) &&
                                                        !empty($row['id'])) {echo $row['id'];} ?>" title="Edit">
                                                        <i class="fa fa-edit" style="font-size: 20px;"></i>
                                                        </a>
                                                        <a href="portfolio_category.php?dId=<?php if(isset($row['id']) && !empty($row['id'])){ echo $row['id']; }?>" onClick="return confirm('Are you sure you want to delete this record');" title="Delete">
