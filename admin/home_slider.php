...
<body class="fixed-left">
        ...
        <div id="wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Add/Update Home Slider</h4>
              ...
              <div class="row card-box">
                <div class="col-md-12">
                  <div  id="Show_target_div">
                    <form  name="homeSliderForm" action="action/home_slider.php/"
            ...
            <?php require_once('view_home_slider.php'); ?>
            <!-- ============================================================== -->
            <!-- End of the page -->
            <!-- ============================================================== -->
        </div>
