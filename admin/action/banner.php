    ...
    if (isset($_POST['check']) && $_POST['check'] != "") {
        ...
        if(isset($_FILES["image"]["name"]) && !empty($_FILES["image"]["name"]))
        {
          ...
          { 
            ...
            $queryUpdate = "UPDATE banner SET description = '$description',image = '$image',dt_updated = '$date' WHERE id = '$id'";
//            print_r($queryUpdate);exit;
      ...
      header('location: '.$location.'../banner.php');
    } else {
        $image = null;
        if(isset($_FILES["image"]["name"]) && !empty($_FILES["image"]["name"]))
        {
        ...
        $description = input_validate($_POST['description']);
        $queryInsert = "INSERT INTO banner(description,image,dt_created) VALUES('$description','$image','$date')";
